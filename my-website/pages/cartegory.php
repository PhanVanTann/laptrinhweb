...
$trademarkObj = new admin;
$show_trademark = $trademarkObj->show_trademark();

$cartegoryObj = new admin;
$show_cartegory = $cartegoryObj->show_cartegory();
?>
...
<section class="cartegory">
        ...
        <div class="cartegory_left_cartegory">
            ...
            <ul>
                <?php if ($show_cartegory): ?>
                    <?php while ($results = $show_cartegory->fetch_assoc()): ?>
                        <li>
                            <input type="checkbox" id="category_<?php echo $results['cartegory_id']; ?>"
                                ...
                                data-value="<?php echo $results['cartegory_id']; ?>">
                    ...
                    <?php while ($results = $show_trademark->fetch_assoc()): ?>
                        <li>
                            <input type="checkbox" id="trademark_<?php echo $results['product_trademark']; ?>"
                                ...
                                data-value="<?php echo urlencode($results['product_trademark']); ?>">
    ...
    <div class="cartegory_right">
        ...
        <div class="cartegory_right_center">
            <?php if ($show_product): ?>
                <?php while ($result = $show_product->fetch_assoc()): ?>
        ...
        <hr>
        <section class="cartegory_right_bottom" id="pagination"></section>
    </div>
</section>
